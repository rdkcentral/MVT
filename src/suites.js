...
(function () {
  ...
  tests.push(new MvtMediaTest(testLongDurationEncryptedVideoPlayback, MS.DASH.PLAYREADY_4_0_CBCS_LONG, engine, null, LONG_DUR_VIDEO_TIMEOUT_MS));
  ...
  tests.push(new MvtMediaTest(testLongDurationEncryptedVideoPause, MS.DASH.PLAYREADY_4_0_CBCS_LONG, engine, null, LONG_DUR_VIDEO_TIMEOUT_MS));
  ...
  tests.push(new MvtMediaTest(testLongDurationEncryptedVideoSetPosition, MS.DASH.PLAYREADY_4_0_CBCS_LONG, engine, null, LONG_DUR_VIDEO_TIMEOUT_MS));
  ...
  tests.push(new MvtMediaTest(testLongDurationEncryptedVideoPlayRate, MS.DASH.PLAYREADY_4_0_CBCS_LONG, engine, null, LONG_DUR_VIDEO_TIMEOUT_MS));
