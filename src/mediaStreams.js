...
var MS = {
  DASH: {
    ...
    PLAYREADY_CENC: {
      variant: "dash",
      container: "fmp4",
      note: "PlayReady with CENC encryption",
      src: "https://media.axprod.net/TestVectors/Dash/protected_dash_1080p_h264_singlekey/manifest.mpd",
      video: {
        codec: "avc",
      },
      audio: {
    ...
    PLAYREADY_CMAF_CBCS: {
      variant: "dash",
      container: "cmaf",
      note: "PlayReady with H.264 multi-key encryption",
      src: "https://media.axprod.net/TestVectors/MultiKey/Cmaf_h264_1080p_cbcs/manifest.mpd",
      video: {
        codec: "avc",
      },
      audio: {
